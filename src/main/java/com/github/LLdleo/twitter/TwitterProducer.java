package com.github.LLdleo.twitter;
...
public class TwitterProducer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        twitterProducer.loadSecret();
        twitterProducer.run();
    }

    public void loadSecret() throws IOException {
        Properties props = new Properties();
        props.load(new java.io.FileInputStream("config/secret.properties"));
        this.consumerKey = props.getProperty("consumerKey");
        this.consumerSecret = props.getProperty("consumerSecret");
